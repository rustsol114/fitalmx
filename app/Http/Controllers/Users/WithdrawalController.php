...
class WithdrawalController extends Controller
{
    ...
    public function withdrawalCreate(Request $request)
    {
        ...
        $withdrawalMethods = PayoutSetting::with(['paymentMethod:id,name'])
        ...
        if ($withdrawalMethods->isEmpty()) {
            $this->helper->one_time_message('error', __('Add Withdrawal Setting'));
            return redirect('payout/setting');
        }
    ...
    public function withdrawalConfirm(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($wallet) {
                ...
                $withdrawalData['payment_description']   = $request->payment_description;
