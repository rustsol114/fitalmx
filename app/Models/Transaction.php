...
class Transaction extends Model
{
    ...
    public function getNoteAttribute($value)
    {
        ...
        $noteArray = json_decode($value, true);
        ...
        if (is_array($noteArray)) {
            ...
            if (isset($noteArray['data']['stpDescripcion'])) {
                $formatedString =  "Descripcion : " . $noteArray['data']['stpDescripcion'] . "<br>";
                $formatedString .=  "Ordenante : " . $noteArray['data']['cuentaOrdenante'] . "<br>";
                $formatedString .=  "TransactionId : " . $noteArray['data']['id'] . "<br>";
            }

            return $formatedString;
        }

        // Return the original value if decoding failed
        return $value;
    }
}
