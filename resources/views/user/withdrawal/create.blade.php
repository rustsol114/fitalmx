...
<div class="bg-white pxy-62 shadow" id="withdrawalCreate">
    ...
    <form method="post" action="{{ route('user.withdrawal.confirm') }}" id="withdrawalCreateForm">
        ...
        <div class="label-top mt-20">
            <label class="gilroy-medium text-gray-100 mb-2 f-15">{{ __('Payment Description') }}</label>
            <input class="form-control input-form-control apply-bg l-s2" name="payment_description" required  value="{{ session('withdrawalData')['payment_description'] ?? old('payment_description') }}">
        </div>
