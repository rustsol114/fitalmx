    ...
    <div class="me-2 me-3">
        <form method="get" id="withdrawalSettingSearchForm">
            <div class="param-ref param-ref-withdraw filter-ref r-filter-ref w-135">
                <select name="payment_method" id="payment_method" class="select2 f-13" id="filter-ref-2" data-minimum-results-for-search="Infinity">
                    ...
                    <div class="modal-body modal-body-pxy">
                        ...
                        <form method="post" action="{{ route('user.withdrawal.setting.store') }}" id="bankPayoutSettingForm" class="payoutSettingForm d-none">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="param-ref param-ref-withdraw money-ref r-mt-11">
                                        <label class="gilroy-medium text-gray-100 mb-2 f-14 leading-17 mt-20 mt-4 r-mt-0">{{ __('Bank Name') }}</label>
                                        <select class="select2 withdraw-type" data-minimum-results-for-search="Infinity" name="bank_name" id="bank_name">
                                            @php
                                            $selectedBank = old('mx_bank_name') ?? $defaultBankName;
                                            @endphp
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="label-top mt-withdraw">
                                        <label class="gilroy-medium text-gray-100 mb-2 f-14 leading-17 mt-20 r-mt-amount r-mt-6">RFC/Curp Beneficiario</label>
                            ...
                            <!-- <div class="row">
                                <div class="col-md-12">
                                    <div class="label-top mt-withdraw">
                                        ...
                                        <input type="text" class="form-control input-form-control input-form-control-withdraw apply-bg" value="{{config('services.stpmex.cuentaBeneficiario')}}" disabled>
                                    </div>
                                </div>
                            </div> -->
