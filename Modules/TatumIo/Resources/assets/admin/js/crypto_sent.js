                ...
                if (res.status == 401) {
                    ...
                    $("#merchant-balance-div")
                        .after(`<div class="form-group row" id="user-address-div">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-control f-14" name="userAddress" id="user-address"></select>
                                    </div>
                                </div>`);

                    // Populate the select dropdown with options from res.userAddresses
                    res.userAddresses.forEach(addressArray => {
                        $('#user-address').append(`<option value="${addressArray.address}">${addressArray.address}</option>`);
                    });
